...
\begin{document}
	...
	\begin{resumo}[Abstract]
		\begin{otherlanguage*}{english}
			...
			\noindent 
			\textbf{Keywords}: Fluid-Structure Interaction. Turbulent Flow. Positional Finite Element Method. Large Eddy Simulation. Variational Multiscale Methods. Reynolds-Averaged Navier-Stokes.
		\end{otherlanguage*}
	\end{resumo}
\end{document}

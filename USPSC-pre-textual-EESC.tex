...
\notafolharosto{VERS\~AO CORRIGIDA\\A versão original encontra-se na Escola de Engenharia de São Carlos}
% ---
% dados complementares para CAPA e FOLHA DE ROSTO
% ---
\universidade{UNIVERSIDADE DE S\~AO PAULO}
\titulo{Análise numérica de problemas de interação fluido-estrutura com vorticidade}
\titleabstract{Numerical analysis of fluid-structure interaction problems with vorticity}
\tituloresumo{Análise numérica de problemas de interação fluido-estrutura com vorticidade}
\autor{Matheus Haubert Yokomizo}
\autorficha{Yokomizo, Matheus Haubert}
...
\newcommand{\programa}[1]{
	...
	\ifthenelse{\equal{#1}{DCEA}}{
		...
		\preambulo{Tese apresentada \`a Escola de Engenharia de S\~ao Carlos da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - Programa de Pós-Graduação em Engenharia Civil (Engenharia de Estruturas).}
		\notaficha{Tese (Doutorado) - Programa de P\'os-Gradua\c{c}\~ao e \'Area de Concentra\c{c}\~ao em Engenharia Civil (Estruturas)}
	}{
		% MCEA ===========================================================================
		\ifthenelse{\equal{#1}{MCEA}}{
			...
			% O preambulo deve conter o tipo do trabalho, o objetivo, 
			% o nome da instituição, a área de concentração e opção quando houver
			\preambulo{Disserta\c{c}\~ao apresentada \`a Escola de Engenharia de S\~ao Carlos da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Mestre em Ci\^encias - Programa de Pós-Graduação em Engenharia Civil (Engenharia de Estruturas).}
			\notaficha{Disserta\c{c}\~ao (Mestrado) - Programa de P\'os-Gradua\c{c}\~ao e \'Area de Concentra\c{c}\~ao em Engenharia Civil (Estruturas)}
		}{
			% DEE =======================================================================

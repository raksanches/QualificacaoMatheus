...
\begin{itemize}[leftmargin=\parindent,labelwidth=\parindent,labelsep=0.3cm]
	...
	\dfrac{\partial {T}^{-1}_{ij}}{\partial {T}_{kl}} = -{T}^{-1}_{ik}{T}^{-1}_{lj} \text{.}%=-\dfrac{1}{2}(\mathbf{T}^{-1}_{il} \mathbf{T}^{-1}_{kj}+\mathbf{T}^{-1}_{ik}\mathbf{T}^{-1}_{lj})   <= CASO SIMETRICO
	\end{equation}
	...
	\dfrac{\partial {T}^{-1}_{ij}}{\partial {T}_{kl}} = -\dfrac{1}{2}\left({T}^{-1}_{ik}{T}^{-1}_{jl} + {T}^{-1}_{il}{T}^{-1}_{jk}\right) \text{.}%=-\dfrac{1}{2}(\mathbf{T}^{-1}_{il} \mathbf{T}^{-1}_{kj}+\mathbf{T}^{-1}_{ik}\mathbf{T}^{-1}_{lj})   <= CASO SIMETRICO
	\end{equation}

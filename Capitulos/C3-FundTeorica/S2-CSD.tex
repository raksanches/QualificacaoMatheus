        ...
        \ForEach{\textnormal{passo de carga}}{
            ...
            \ForEach{\textnormal{iteração de Newton-Raphson}}{
                \ForEach{\textnormal{elemento}}{
                    ...
                    Calcular $\BB{C}^{n+1}=(\FMC^{n+1})^T\cdot\FMC^{n+1}$ e $\BB{C}^{n+\alpha_f}=(\FMC^{n+\alpha_f})^T\cdot\FMC^{n+\alpha_f}$\;
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.4\linewidth]{Figuras/cylinder-shell/ANSYS.png}
    \\Fonte: ANSYS (\the\year).

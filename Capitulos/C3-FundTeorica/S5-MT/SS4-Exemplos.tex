...
A simulação foi conduzida com uma malha estruturada com orientação à esquerda para elementos triangulares de aproximação linear (estabilizado por SUPG/PSPG), quadrática (estabilizado por SUPG/PSPG e VMS) e P2P1 sem termos estabilizadores, em simulação DNS e com aplicação do modelo LES. A malha utilizada para a simulação de elementos lineares possui 12800 elementos enquanto para a simulação de elementos quadráticos e P2P1 possui 3200 elementos. Assim as simulações de elementos lineares e quadráticos possuirão um total de 6561 nós, o que resulta em 19683 graus de liberdade, enquanto a simulação em elementos P2P1 possuirá 14803 graus de liberdade.
...
\begin{table}[h!]
    ...
    \begin{tabular}{llllc}
        ...
        LES1 & LES    & P2P1       & -             & 21417         \\
        LES2 & LES    & Quadrático & SUPG/PSPG     & 28494         \\\hline
    \end{tabular}
    \\Fonte: Autoria Própria (\the\year).
    \label{tab:cyl-sim}
\end{table}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=\linewidth]{Figuras/cylinder/analise3/Cd}
    \\Fonte: Autoria Própria (\the\year).
    \label{fig:cyl-Cd}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[width=\linewidth]{Figuras/cylinder/analise3/Cl.pdf}
    \\Fonte: Autoria Própria (\the\year).
    \label{fig:cyl-Cl}
\end{figure}
...
\begin{table}[h!]
    ...
    \caption{Valores das propriedades de $C_D$ e $C_L$ nas simulações.}
    \begin{tabular}{lccccc}
        \hline
        \MR{2}{*}{Simulação} & \ccelc{Média} & \ccelc{Amplitude} & \MR{2}{*}{$\Str$}                         \\\cline{2-5}
                             & \celc{$C_D$}  & \celc{$C_L$}      & \celc{$C_D$}      & \celc{$C_L$} &        \\\hline
        DNS1                 & 1,3458        & 0,0002            & 0,0095            & 0,3283       & 0,1642 \\
        DNS2                 & 1,3488        & -0,0014           & 0,0094            & 0,3255       & 0,1647 \\
        DNS3                 & 1,3480        & -0,0009           & 0,0095            & 0,3279       & 0,1650 \\
        LES1                 & 1,3445        & 0,0003            & 0,0093            & 0,3264       & 0,1639 \\
        LES2                 & 1,3466        & -0,0007           & 0,0094            & 0,3259       & 0,1646 \\\hline
    \end{tabular}
    \\Fonte: Autoria Própria (\the\year).
    \label{tab:cyl-res}
\end{table}

...
A Figura \ref{fig:NACA0012-QCriterion} apresenta as isosuperfícies onde o critério Q é nulo ($Q=(\Ny\BB{u}:\NyT\BB{u})/2$) para o instante $t=5,0$, colorido de acordo com a intensidade da velocidade. Essa medida é comumente utilizada para identificar as regiões onde a vorticidade á dominante ($Q>0$) e onde a taxa de deformação é dominante ($Q<0$) \cite{hunt1988eddies,piomelli2000large}

...
\noindent onde $N_a$ são as funções de forma associadas ao nó $a$ da malha e $\BB{\eta}^s$ o respectivo índice desse nó, assim como $\BB{\eta}^w$ são os índices referentes aos nós da malha para as funções teste.
...
\begin{subequations}
    ...
    \end{equation}
    \begin{equation}
        \NCi{a}=\intDom{N_a\bar{u}_{i,i}}-\SintDom{N_{a,i}u'_i}=0
    \end{equation}

...
\begin{algorithm}[h!]
    ...
    $
        \begin{bmatrix}
            \dBB{U}_{n+\alpha_m} \\\BB{U}_{n+\alpha_f}\\\BB{P}_{n+1}
        \end{bmatrix}^{k+1}\gets
        \begin{bmatrix}
            \alpha_m \BB{\dot{U}}_{n+1}+(1-\alpha_m)\BB{\dot{U}}_n \\
            \alpha_f \BB{U}_{n+1}+(1-\alpha_f)\BB{U}_n             \\
            \BB{P}_n
        \end{bmatrix}^{k-1}
    $\\
    ...
    $
        \begin{bmatrix}
            \dBB{U} \\\BB{U}\\\BB{P}
        \end{bmatrix}_{n+1}^{k+1}\gets
        \begin{bmatrix}
            \dBB{U} \\\BB{U}\\\BB{P}
        \end{bmatrix}_{n+1}^{k}+
        \begin{bmatrix}
            \Delta\dBB{U} \\\gamma\Delta t\Delta\dBB{U}\\\Delta\BB{P}
        \end{bmatrix}_{n+1}^{k}
    $\\

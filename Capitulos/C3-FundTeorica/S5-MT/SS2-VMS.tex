...
O integrador temporal utilizado no presente trabalho é o denominado integrador $\alpha$-generalizado, desenvolvido por \citeonline{chung1993time}, no contexto da mecânica dos sólidos, e expandido por \citeonline{jansen2000generalized} para análises da mecânica dos fluidos. Tal integrador possui vantagens, como a capacidade de representar adequadamente problema de escoamentos incompressíveis, além de permitir a introdução de difusão numérica ao processo de forma controlada \cite{fernandes2020tecnica}.

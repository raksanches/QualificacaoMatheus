...
\begin{equation}
    \begin{split}
        &\intDom{\BBB{w}\cdot\rho\bigpar{\dot{\BBB{u}}+(\BB{u}-\HBB{u})\cdot\Ny\BBB{u}-\BB{f}}}+\intDom{\Ny\BB{w}:\bar{\tens}}-\intNeumann{\BBB{w}\cdot\BBB{h}}+\\
...
\begin{subequations}
    \begin{equation}
        \begin{split}
            \NM^a=&
            \intDom{N_a^u\rho\bigpar{\dot{\BBB{u}}+(\BBB{u}-\HBB{u})\cdot\Ny\BBB{u}-\BBB{f}}}+\intDom{\Ny N_a^u\cdot\bar{\tens}}-\\
...
\begin{subequations}
    \begin{equation}
        \begin{split}
            \der{\NM^a}{(\dBB{U}^b)^{n+1}}=&\am\intDoma{\kr{a}N_b}\BB{I}+\agdt\intDoma{\kr{a}\dconv{b}}\BB{I}+\\
            &\agdt\intDoma{\mu \Ny N_a\cdot\Ny N_b}\BB{I}+\agdt\intDoma{\kr{a}N_b\Ny\BBB{u}}+\\

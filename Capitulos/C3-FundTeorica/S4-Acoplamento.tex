...
Verifica-se que a aplicação dos demais termos estabilizadores presentes na formulação VMS levaram a uma solução mais amortecida em relação ao SUPG/PSPG, provavelmente devido à uma maior dissipação de energia que os termos adicionais podem causar. No entanto, a aplicação do modelo LES não surtiu efeito na solução encontrada, o que se deve ao fato do número de Reynolds do problema ser baixo, além de possuir gradientes de velocidade também muito pequenos.

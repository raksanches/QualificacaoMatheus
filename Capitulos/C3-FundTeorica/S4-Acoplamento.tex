...
\begin{figure}[h!]
    ...
    \\Fonte: Presente trabalho (\the\year)
    \\Nota: A linha referente à simulação LES sobrepõe a de SUPG/PSPG; e a linha referente à LES-VMS sobrepõe a VMS.

...
A Figura \ref{fig:cavity2D-time} apresenta o campo de pressão na cavidade, assim como as linhas de corrente, para a simulação quadrática os instantes de tempo $t=3,5$, $8,0$, $14,0$ e $21,0$, sendo próximos aos campos encontrados por \citeonline{fernandes2016interaccao}.

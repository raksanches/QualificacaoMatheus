...
Os escoamentos isotérmicos incompressíveis são governados pelos princípios da conservação da massa e da conservação da quantidade de movimento, que na descrição ALE resultam em (ver anexo \ref{Ap:CFD}):

\textcolor{red}{colocar equações}.
...
Dessa forma, ponderando-se as equações \eqref{} e \eqref{} \textcolor{red}{Citar} respectivamente por $\BB{w}$ e $q$, tal que $q \in  \script{V}_p$ e integrando-se sobre o domínio $\Omega$, obtém-se:

...
\begin{equation}
    \begin{bmatrix}\Nx\BB{y}&\BB{u}\\\BB{0}^T&1\end{bmatrix}=
    \begin{bmatrix}\Nxh\BB{y}&\uhat\\\BB{0}^T&1\end{bmatrix}\cdot
    \begin{bmatrix}\Nx\HBB{x}&\tilde{\BB{u}}\\\BB{0}^T&1\end{bmatrix}\text{,}
    \label{F4}
\end{equation}
...
\begin{equation}
    ...
    \begin{bmatrix}\Nx\HBB{x}&\tilde{\BB{u}}\\\BB{0}^T&1\end{bmatrix}
    \text{.}
    \label{phi2}
\end{equation}

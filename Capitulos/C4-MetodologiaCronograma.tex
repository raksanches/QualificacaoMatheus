...
\begin{table}[H]
	...
	\begin{tabular}{c|cc|cccccccccccc|cc}
		\hline
		    ...
		    \ref{M:1} & \cmark & \cmark & & & & & & & & & & & & & & \\ \hline
		    \ref{M:2} & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \\ \hline
		    \ref{M:3} & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & & & & & & & & \\ \hline
		    \ref{M:4} & & & & & \cmark & \cmark & \cmark & & & & & & & & & \\ \hline
		    \ref{M:5} & & & & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & & & & \\ \hline
		    \ref{M:6} & & & & & & & & & & & & \cmark & \cmark & & & \\ \hline
		    \ref{M:7} & & & & & & & & & & & & & \cmark & \cmark & \cmark & \\ \hline
		    \ref{M:8} & & & & & & & & & & & & & & \cmark & \cmark & \cmark \\ \hline
	\end{tabular}
    \label{Cronograma}
\end{table}

...
\begin{table}[H]
	...
	\begin{tabular}{c|cc|cccccccccccc|cc}
		\hline
		\MR{2}{*}{Item} & \MC{2}{c|}{2022} & \MC{12}{c|}{2023} & \MC{2}{c}{2024}                                                                               \\ \cline{2-17}
		                & Nov              & Dez               & Jan             & Fev & Mar & Abr & Mai & Jun & Jul & Ago & Set & Out & Nov & Dez & Jan & Fev \\ \hline
		\ref{M:1}       & \CM              & \CM               &                 &     &     &     &     &     &     &     &     &     &     &     &     &     \\ \hline
		\ref{M:2}       & \CM              & \CM               & \CM             & \CM & \CM & \CM & \CM & \CM & \CM & \CM & \CM & \CM & \CM & \CM & \CM &     \\ \hline
		\ref{M:3}       & \CM              & \CM               & \CM             & \CM & \CM & \CM &     &     &     &     &     &     &     &                 \\ \hline
		\ref{M:4}       &                  &                   &                 &     & \CM & \CM & \CM &     &     &     &     &     &     &     &     &     \\ \hline
		\ref{M:5}       &                  &                   &                 & \CM & \CM & \CM & \CM & \CM & \CM & \CM & \CM & \CM &     &     &     &     \\ \hline
		\ref{M:6}       &                  &                   &                 &     &     &     &     &     &     &     &     & \CM & \CM &     &     &     \\ \hline
		\ref{M:7}       &                  &                   &                 &     &     &     &     &     &     &     &     &     & \CM & \CM & \CM &     \\ \hline
		\ref{M:8}       &                  &                   &                 &     &     &     &     &     &     &     &     &     &     & \CM & \CM & \CM \\ \hline
	\end{tabular}
	\label{Cronograma}
\end{table}

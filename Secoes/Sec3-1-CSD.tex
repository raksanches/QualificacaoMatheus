...
\begin{figure}[h]
    ...
    \includegraphics[width=0.5\linewidth]{Figuras/Barra.pdf}
...
\begin{subequations}
    ...
    \end{equation}
    \begin{equation}
        \apder{\sigma_{ij}}{y_i}+c_j=\rho\Ddot{y}_j\text{,}\label{eq:EqLocEu2}
    \end{equation}
    \label{eq:EqLocEu}
\end{subequations}
...
\begin{subequations}
    ...
    \end{equation}
    \begin{equation}
        \apderx{P_{ij}}{x_i}+c_j=\rho\Ddot{y}_j\text{.}
    \end{equation}
\end{subequations}
...
%==================================================================================================
\subsubsection{Elemento de Pórtico} \label{MEFP-Por}
%==================================================================================================

\textcolor{red}{Talvez alterar para elemento de treliça - Pode comentar sobre vibração livre}

%==================================================================================================
\subsubsection{Elemento de Sólido Bidimensional} \label{MEFP-S2D}
%==================================================================================================

\textcolor{red}{Comentar sobre polinômios aproximadores, coordenadas paramétricas, integração por quadratura de Gauss e Hammer, mudança de variáveis para espaço paramétrico, método de solução}

...
\begin{simbolos}
    ...
    \item[\textbf{Movimentação dinâmica da malha}]
    \item[$\BB{B}$] Matriz tangente do problema de Laplace
    \item[$\BB{z}$] Campo de deslocamentos da malha
    \item[$\BB{Z}_a$] Valor de $\BB{z}$ sobre o nó $a$
    \item[$\BB{z}_m$]  Valores prescritos de deslocamentos em $\Gamma_m$
    \item[$\Delta{Z}$] Vetor de correção dos valores nodais de deslocamento
    \item[$\res_L$] Vetor resíduo do problema de Laplace
    \item[$\eta$] Amplificação de rigidez dos elementos menores
    \item[$\BB{\upsilon}$] Função teste relacionado ao problema de Laplace
    \item[$\BB{\Upsilon}_a$] Valor de $\BB{\upsilon}$ sobre o nó $a$
    ...
    \item[$\NM$] Vetor de resíduo referente à equação da conservação da quantidade de movimento
    \item[$\NC$] Vetor de resíduo referente à equação da continuidade

...
\titulo{Análise numérica bidimensional de interação fluido-estrutura com contato estrutural}
\titleabstract{English title}
\autor{Darcy Hannah Falc\~{a}o Rangel Moreira }
\autorficha{Darcy Hannah Falcão Rangel Moreira }
\autorabr{MOREIRA, D. H. F. R.}
...
\preambulo{Projeto de pesquisa apresentado ao programa de p\'os-gradua\c{c}\~ao em Engenharia de Estruturas da Escola de Engenharia de S\~ao Carlos.}
\notaficha{Projeto de pesquisa (Mestrado) - Programa de P\'os-Gradua\c{c}\~ao em Engenharia Civil (Engenharia de Estruturas) e \'Area de Concentra\c{c}\~ao em Estruturas}

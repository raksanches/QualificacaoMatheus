clean:
	...
	@$ -rm .vscode Abstract.pdf Resumo.pdf

gen: clean ; pdflatex _ArquivoPrincipal.tex ; bibtex _ArquivoPrincipal.aux ; pdflatex _ArquivoPrincipal.tex ; pdflatex _ArquivoPrincipal.tex
